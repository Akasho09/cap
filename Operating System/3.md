...
> OTHER PROCESS DOES BUSY WAITING , SOLVED BY Condition Variables.
...
| --------- | -------- | ---------------------------- |
| `empty`   | Counting | Counts empty slots in buffer |
| `full`    | Counting | Counts filled slots          |
| `mutex`   | Binary   | Ensures mutual exclusion     |

## ⚠️ Drawbacks of Semaphores
1. 🔹 3. Starvation

2. 🔹 4. Busy Waiting (in some implementations)

3. 🔹 5. No Ownership Concept

4. 🔹 7. Not Scalable for Complex Systems
