...
- **Candidate keys are (student, teacher) and (student, subject)**. ABOVE TABLE IS IN 2NF(cz subject is not Non Prime Attribute) AND 3NF.
...
- No MultiValued Dependency.
    - Example : 2 Mobile Numbers and 2 Emails.

5. 5th NF :
- No lossless Deccopoition.
